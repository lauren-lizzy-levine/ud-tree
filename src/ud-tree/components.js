...
class Sentence extends React.Component {
  ...
  handleMouseUp(e) {
    ...
    this.setState({
      ...
      cursorCoords: null,
      cursorOriginId: null,
      sentence: this.setHead(this.state.sentence, id, headId)
    });
  }
    ...
    return (
      <div className="sentence" onMouseMove={this.handleMouseMove}>
        <svg key="svg" className="tree-svg" ref={this.svgRef}>
          <rect key="root-bar" width="50000" height="20" x="0" y="0" className="root-bar" onMouseDown={this.handleRootMouseDown} />
          {edges}
          {labels}
          {selects}
        </svg>
